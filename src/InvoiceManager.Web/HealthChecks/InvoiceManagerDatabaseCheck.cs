...
public class InvoiceManagerDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public InvoiceManagerDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
